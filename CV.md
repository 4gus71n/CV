...
I'm a Mobile Engineer with over a decade of experience in Android and iOS development. From the early days of Android 2.2 and ActionBarSherlock to modern architectures like MVVM with Jetpack Compose, I've built and led mobile teams across startups and large enterprises. I’m passionate about scalable architecture, remote collaboration, and mentoring engineers to reach their potential.
...
* Took the lead of the Android team as soon as I joined, improving our PR review process to boost code quality.

* Patched up the G6 integration in my first week to ensure continuity in production.

* Implemented full integration with the G7 hardware device.

* Developed a system to share test builds with users, enabling faster and more precise issue resolution.

* Designed and implemented a hiring pipeline to attract top mobile engineering talent.
...
* Released a long-overdue feature that enabled account creation via phone number.

* Delivered the "Muster" feature, enabling recruits and recruiters to easily communicate.

* Led the migration from DaggerInject to Hilt.

* Refactored the app into a multi-module architecture.

* Fixed high-priority production bugs and coordinated with the Customer Happiness team to address user feedback.

* Improved engineering processes by introducing a PR template and encouraging screen recording for better context.

* Promoted company-wide communication improvements for better remote collaboration.
...
* Built the Glide Android app from scratch, laying the foundation architecture.

* Led a 4-person mobile team across both Android and iOS platforms.

* Contributed to Business Tracker flow improvement in Compass.

* Guided team members through Compass acquisition onboarding.

* Implemented in-memory caching using Room to optimize shared data.

* Applied Dagger and Hilt in a multi-module setup, exposing components via SubComponents.
...
* Fixed a production bug on day one.

* Led the implementation of a new job scheduling feature that improved user engagement and time efficiency.

* Introduced Kotlin Synthetics for simpler view referencing.

* Improved test coverage with Robolectric and Espresso.
...
* Briefly worked on a retail project for Apple.
...
* Worked on the Royal Caribbean passenger app.

* Navigated timezone challenges between engineering (India) and product (US West Coast).

* Pushed for the adoption of dependency injection using Dagger.
...
* Trained junior engineers on Android development.

* Delivered core architecture and streaming functionality for a radio app.
...
* Scaled app to support nearly 300k DAU.

* Migrated from MVP to MVVM, and from single- to multi-module architecture.

* Introduced offline-first support using RxJava.

* Contributed to performance improvements across builds.
...
* Created DirecTV tool to align antennas using Android sensors.

* Delivered Gulfstream's in-flight apps for passengers, crew, and pilots.

* Worked in cross-functional teams sharing a unified core project.

[Gulfstream Cabin Comfort App](https://play.google.com/store/apps/details?id=com.gulfstream.gcms.client.cabincomfort)
...
* Built radio streaming apps and improved MediaPlayer performance via NDK.

* Developed an e-commerce app for trading goods.

* Built a social network app with Estimote beacon integration for indoor geolocation.

[Secretos App](https://android-apk.org/com.arzion.secretos/6451351-secretos/) • [Streame App](https://apk.support/app/com.arzion.streame)
...
* Began with Spring MVC backend development.

* Transitioned into mobile via Apache Cordova, then native Android.

* Developed a student-oriented TODO tracker for the university.
